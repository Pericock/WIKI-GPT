// ============================================================
//  WIKI-GPT — app.js  (v3 - Corregido)
//  Fix: rutas de PDF relativas al index.html (raíz del repo)
//  Así funciona tanto en GitHub Pages como en Live Server
// ============================================================

function assetURL(filename) {
  // Al quitar la barra inicial, busca la carpeta assets desde donde esté el index.html
  return `assets/${filename}`;
}

function xmlURL() {
  // Al quitar la barra inicial, busca la carpeta data desde donde esté el index.html
  return `data/contenidos.xml`;
}
